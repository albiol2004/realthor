      ...
      <div className="w-full max-w-6xl space-y-8">
        ...
        <div className="flex items-center justify-center gap-3 flex-wrap">
          ...
          <button
            ...
            className={`px-6 py-2 rounded-lg font-medium transition-colors ${billingCycle === 'quarterly'
              ? 'bg-black dark:bg-white text-white dark:text-black'
              : 'bg-white dark:bg-black text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-900'
              }`}
          >
        ...
        <div className="text-center space-y-4 pt-4">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Contact us at{' '}
            <a href="mailto:support@realthor.app" className="text-purple-600 dark:text-purple-400 hover:underline">
